...
for i in range(num_patient_files-850): #USED TO BE 100, tqdm
...
# csv_path = r"C:\Users\praneelpatel\Downloads\data.csv"
...
#         sequence_data = (row['sequence_data'])  # Convert sequence_data to a string
#         label = row['label']
